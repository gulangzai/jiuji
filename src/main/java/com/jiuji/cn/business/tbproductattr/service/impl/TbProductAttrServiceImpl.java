package com.jiuji.cn.business.tbproductattr.service.impl;
...
import com.jiuji.cn.business.tbproductattr.dao.TbProductAttrDao;
...
public class TbProductAttrServiceImpl implements TbProductAttrService {
	...
	*/
	...
	public List<TbProductAttr> findBy(PageData tproduct) throws Exception {
		// TODO Auto-generated method stub
		return (List<TbProductAttr>)tbProductAttrDao.findForList("TbProductAttrMapper.findBy", tproduct);
	}
