package com.jiuji.cn.business.pictures.controller;
 ...
 */
@Controller
@RequestMapping(value = "/tbPicturesController")
public class TbPicturesController extends BaseController {

	String menuUrl = "tbPicturesController/list.do"; // 菜单地址(权限用)
	...
	public Object save(@RequestParam(required = false) MultipartFile file, HttpServletRequest request)
		...
		map.put("PATH", rootFile + "/" + ffile + "/" + fileName); // 路径
	...
	/**
	 * 根据table table_uid_value获取图片
	 */
	@RequestMapping(value = "/getPicture")
	@ResponseBody
	public List<PageData> getPicture(HttpServletRequest request,
			@RequestParam(value = "TABLE", required = true) String table,
			@RequestParam(value = "TABLE_UID_VALUE", required = true) String table_uid_value) throws Exception {
		logBefore(logger, "修改Pictures");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		List<PageData> pds = picturesService.getPicture(pd);
		return pds;
	}
	...
	public ModelAndView list(Page page) {
		...
		try {
			...
			mv.setViewName("business/pictures/pictures_list");
	...
	public ModelAndView goAdd() {
		...
		pd = this.getPageData();
		try {
			mv.setViewName("business/pictures/pictures_add");
			mv.addObject("pd", pd);
		} catch (Exception e) {
			logger.error(e.toString(), e);
		}
	...
	public ModelAndView goEdit() {
		...
		try {
			...
			mv.setViewName("business/pictures/pictures_edit");
