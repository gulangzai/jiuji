package com.jiuji.cn.business.tbsize.service.impl;
...
import com.jiuji.cn.business.tbsize.dao.TbSizeDao;
...
public class TbSizeServiceImpl implements TbSizeService {
	...
	*/
	...
	@Override
	public List<PageData> findBy(PageData tproduct) throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)tbSizeDao.findForList("TbSizeMapper.findBy", tproduct);
