package com.jiuji.cn.business.tbcolor.service.impl;
...
import com.jiuji.cn.business.tbcolor.dao.TbColorDao;
...
public class TbColorServiceImpl implements TbColorService {
	...
	*/
	...
	public List<PageData> findBy(PageData queryProductPara)throws Exception {
		// TODO Auto-generated method stub
		return (List<PageData>)tbColorDao.findForList("TbColorMapper.findBy", queryProductPara);
	}
