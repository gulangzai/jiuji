...
<!-- datatable css -->
		<style type="text/css" title="currentStyle">
			@import "${pageContext.request.contextPath }/assets/sys_resources/css/demo_table.css";
		</style>
	<!-- datatable css -->
	
<!-- datatable js -->
<script type="text/javascript" src="${pageContext.request.contextPath }/assets/sys_resources/plugins/datatable/jquery-latest.js"> </script>
<script type="text/javascript" src="${pageContext.request.contextPath }/assets/sys_resources/plugins/datatable/jquery.dataTables.js"> </script>
