...
{
	var alertHTML  = "<div id=\"pubAlert\" class=\"alert hide alert-success success-b-open\">";
            	...
            	if ($this.attr("src").substr(0,2).toUpperCase() == "T#"){
                            	...
                            	if(dic_dom){
                                 ...
                                 for(var i = 0;i<list.length;i++){
                                      ...
                                      if($this.attr("onchange")){
                                    	  onchangeHTML = "onchange=\""+$this.attr("onchange")+"\"";
                		    			  }
    		    	...
    		    	if(list.length>0){
            		 ...
            		 $.ajax({
           			  ...
           			  async:false,
           			  cache:false,
           			  url: g_sDicPath + $this.attr("src") + ".xml",
           			  data:{},
           			  dataType: "text",
                     ...
                     if(dic_dom){
                      ...
                      var temp = "";
                      //for(var i = 0;i<list.length;i++){
                      $(dic_dom).find('R').each(function() {
                      	 //var code = list[i].getAttribute("c");
                         //  var value = list[i].getAttribute("t");
                    	  var code = $(this).attr("c");
                          var value = $(this).attr("t");
   		    		  	  var onclickHTML = "";
                          if($this.attr("onclick")){
  		    				onclickHTML = "onclick=\""+$this.attr("onclick")+"\"";
  		    			  }
                          ...
                          if(lineType!=undefined&&lineType!=null&&lineType=="upline"){
                           ...
                           if($this.attr("type")=="radio"){
                               temp +=("<label class=\"ace"+lineType+"\"><input type=\"radio\"  "+onclickHTML+" name=\""+$this.attr("name")+"\" value='"+code+"'  sv='"+value+"'>"+value+"</label>&nbsp;&nbsp;&nbsp;");
                           }else{
                               temp +=("<label class=\"ace"+lineType+"\"><input type=\"checkbox\"  "+onclickHTML+" name=\""+$this.attr("name")+"\" value='"+code+"'  sv='"+value+"'>"+value+"</label>");  
                           }
                         //}
                      });
                      $this.after(temp);
