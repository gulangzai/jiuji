function showPopupAdv(B) {
    ...
    this.init = function() {
        ...
        if (this.showclosed) {
            jQuery("#" + this.pdivId + "").html(jQuery("#" + this.pdivId + "").html() + "<img style='display:none;position:absolute;right:5px;top:6px;z-index:2;cursor:pointer;' src='http://i3.dukuai.com/ui/style/09/img/float_ad_closed.gif' class='closedbutton' title='�ر�' />")
        }
...
function showFullScreenAdv(A) {
    ...
    this.run = function() {
        jQuery("#" + this.divId + "").html("<a class='fade_btn' ></a><div class='fade_border'></div><div class='fade_main'><img class='fade_closed' src='"+ctxStaticB+"/system/advertise/images/dk_ad_closed.gif' height='19' width='19'/>");
        ...
        jQuery("#" + this.divId + " .fade_btn").css({
            ...
            "line-height": "19px",
            "text-align": "center",
            background: "url("+ctxStaticB+"/system/advertise/images/bn_play.gif)"
        });
        jQuery("#" + this.divId + " .fade_border").css({
            display: "none",
            left: "995px",
...
(function() {
    var U = [{
        ...
        advParam: "ad_bbs_0804hunbo_980*60",
        advUrl: ctxStaticB+"/system/advertise/images/ad2.gif",
        advLink: "https://www.jiujichina.com/jiuji/",
        advWidth: 980,
        advType: "7",
        advHeight: 60
    }];
