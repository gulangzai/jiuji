...
///////////////////////////	推荐商品
	var ia=0
	var clone1=$(".lunbobanner1 .lunboimg1 li").first().clone();
	$(".lunbobanner1 .lunboimg1").append(clone1)
	var size1=$(".lunbobanner1 .lunboimg1 li").size()
	/*自动轮播*/
	var t1=setInterval(moveL1,5000)
	/*定时器的关闭与开启*/
	$(".kongzhianniu1").hover(function(){
		clearInterval(t1);
		
	},function(){
		t1=setInterval(moveL1,5000)	 
    })
	...
	function moveL1(){
		ia++
		if(ia==size1){
			$(".lunboimg1").css({left:0})
			  ia=1;
			}
		$(".lunboimg1").stop().animate({left:-ia*1200},500)
	...
	function moveR1(){
		ia--
		if(ia==-1){
			$(".lunboimg1").css({left:-(size1-1)*1200})
			ia=size1-2;
			}
		$(".lunboimg1").stop().animate({left:-ia*1200},500)
    }
 ...
 ///////////////////////////////// 产品特卖
	...
	var ib=0
	var clone2=$(".lunbobanner2 .lunboimg2 li").first().clone();
	$(".lunbobanner2 .lunboimg2").append(clone2)
	var size2=$(".lunbobanner2 .lunboimg2 li").size()
	/*自动轮播*/
	var t2=setInterval(moveL2,5000)
	/*定时器的关闭与开启*/
	$(".kongzhianniu2").hover(function(){
		clearInterval(t2);
		
	},function(){
		t2=setInterval(moveL2,5000)	 
    })
	...
	function moveL2(){
		ib++
		if(ib==size2){
			$(".lunboimg2").css({left:0})
			  ib=1;
			}
		$(".lunboimg2").stop().animate({left:-ib*1200},500)
	...
	function moveR2(){
		ib--
		if(ib==-1){
			$(".lunboimg2").css({left:-(size2-1)*1200})
			 ib=size2-2;
			}
		$(".lunboimg2").stop().animate({left:-ib*1200},500)
    }
