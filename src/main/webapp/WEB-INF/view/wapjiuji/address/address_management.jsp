...
<head>
    ...
    <link rel="stylesheet" href="${ctxStaticB}/wapjiuji/address/css/address_management.css"/>
    <script>
        (function (doc, win) {
...
<body>
    ...
    <footer class="address-management-footer">
        <div>新增收货地址</div>
    </footer>
   ...
   <script>
     ...
     $(".address-management-footer").click(function(){
        			...
        			if(data!=null){ 
        				...
        				$.each(data.data, function (index, item) { //遍历返回的json
		        		 ...
		        		 var html = '<div class="single-address">';
		                     ...
		                     html=html+'</p>';
		                     html=html+'<p class="consignee-address">'+item.F_ADDRESS_DETAIL+'</p>';
		                     html=html+'</div>';
		                     html=html+'<div class="operating clearfix">';
		                     html=html+'<div>';
		                     html=html+'<i class="circle-icon"></i>';
		                     html=html+'<span>设为默认</span>';
		                     html=html+'</div>';
		                     html=html+'<div>';
		                     html=html+'<label>';
		                     html=html+'<i class="edit-icon"></i>';
		                     html=html+'<span>编辑</span>';
		                     html=html+'</label>';
		                     html=html+'<label>';
		                     html=html+'<i class="delete-icon"></i>';
		                     html=html+'<span>删除</span>';
		                     html=html+'</label>';
		                     html=html+'</div>';
		                     html=html+'</div>';
		                     html=html+'</div>';
                        ...
                        console.info($(".swiper-slide").html());
