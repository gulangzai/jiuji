...
<%@ page import="com.lanbao.utils.com.alipay.config.*"%>
<%@ page import="com.lanbao.utils.com.alipay.util.*"%>
...
<html>
	...
	<%
        ...
        //付款金额，必填
        String total_fee = new String(request.getParameter("WIDtotal_fee").getBytes("UTF-8"),"UTF-8");
