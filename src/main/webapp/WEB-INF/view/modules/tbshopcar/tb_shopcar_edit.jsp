...
<div class="modal-dialog"  tabindex="-1" role="dialog" style="width:80%">
   <div class="modal-content">
      ...
      <div class="modal-body">
             <form class="form-horizontal" action="${ctx}/tbshopcar/tbShopCarController/edit.do" role="form" name="Form" id="editForm" method="post">
 ...
 function init(){ 
		...
		$.ajax({
			url : "${ctx}/tbshopcar/tbShopCarController/goEdit.do",
			data : data1,
			cache : false,
			async :	false,
			dataType : "json",  
	...
	function setValue(obj){  
		...
		getPicFile("TB_SHOPCAR",obj.F_ORDER_UID);
    }
	...
	function update(){
		...
		$.ajax({
			url : "${ctx}/tbshopcar/tbShopCarController/edit.do",
